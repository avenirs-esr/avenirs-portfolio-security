package fr.avenirsesr.portfolio.security.principal.infrastructure.adapter.specification;
 ...
 *
 * <p>Description: Specification used to filter Structures.
 *
 * <h2>Version:</h2>
 *
 * 1.0
...
public abstract class StructureSpecificationHelper {
   ...
   */
  public static Specification<StructureEntity> filterByIds(UUID... ids) {
