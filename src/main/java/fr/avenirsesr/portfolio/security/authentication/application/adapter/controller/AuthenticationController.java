...
public class AuthenticationController {
  ...
  public ResponseEntity<OIDCAccessTokenResponse> oidcCallback(
    ...
    OIDCAccessToken accessToken =
        this.authenticationService.exchangeAuthorizationCodeForToken(
  ...
  public void redirect(
    ...
    response.sendRedirect(
        this.authenticationService.generateServiceURL(host == null ? "localhost" : host));
  }
  ...
  public OIDCProfileResponse profile(@RequestHeader(value = "x-authorization") String token) {
    OIDCIntrospection introspection = this.authenticationService.introspectAccessToken(token);

    if (introspection != null && introspection.active()) {
      OIDCProfile profile = this.authenticationService.profile(token);
