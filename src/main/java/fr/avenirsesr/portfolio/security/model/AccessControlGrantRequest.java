 ...
 *
 * <p>Description: AccessControlGrantRequest is used to grant a role to a principal. The granted
 * role can be associated to specific resources and limited to an application context.
 *
 * <h2>Version:</h2>
 *
 * 1.0.0
