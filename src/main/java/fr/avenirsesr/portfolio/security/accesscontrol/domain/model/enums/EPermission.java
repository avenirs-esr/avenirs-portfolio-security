...
public enum EPermission {
  ...
  PERM_ACTIVITY_CATALOG_READ_CONTEXTUAL("View the activity catalog"),
  PERM_ACTIVITY_REGISTER_OWN("Register for an activity"),
  PERM_ACTIVITY_READ_CONTEXTUAL("View activity details"),
  PERM_ACTIVITY_DOCUMENT_DOWNLOAD_CONTEXTUAL("Download an activity's documents and links"),
  PERM_ACTIVITY_DOCUMENT_READ_CONTEXTUAL("View an activity's documents and links"),
  ...
  PERM_ACTIVITY_PUBLISHED_UPDATE_CONTEXTUAL("Update a published national activity"),
  ...
  PERM_FEEDBACK_REQUEST_READ_ASSIGNED_CONTEXTUAL("View feedback requests assigned to them"),
  PERM_FEEDBACK_REQUEST_RESPOND_ASSIGNED_CONTEXTUAL("Respond to an assigned feedback request"),
  PERM_FEEDBACK_HISTORY_READ_CONTEXTUAL("View the feedback history of their institution"),
  PERM_FEEDBACK_DASHBOARD_READ_CONTEXTUAL("View the feedback dashboard of their institution"),
