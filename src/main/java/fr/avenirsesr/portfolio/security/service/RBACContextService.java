 ...
 *
 * <p>Description: is used to retrieve Application Context.<br>
 * <strong>Application Context:</strong> restriction on assignments. For instance a role can be
 * assigned to a principal with a period of validity or for a given structure.<br>
 * <strong>Execution Context:</strong> context computed at runtime,for instance the current date or
 * the list of structures associated to the principal. <br>
 *
 * <h2>Version:</h2>
 *
 * 1.0
...
public class RBACContextService {
  ...
  @Autowired private RBACContextRepository contextRepository;
  ...
  public RBACContext updateContext(RBACContext context) {
    ...
    return this.contextRepository
        ...
        .orElseThrow(
            () -> new EntityNotFoundException("Entity not found with ID: " + context.getId()));
  }
