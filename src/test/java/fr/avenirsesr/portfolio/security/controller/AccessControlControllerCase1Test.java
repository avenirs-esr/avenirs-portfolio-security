 ...
 *
 * <p>Description: test case 1. User deman is owner of resource of type portfolio. For more details
 * <a href="https://avenirs-esr.github.io/dev-doc/arch-soft-specif-security-rbac-test-case1/">
 * https://avenirs-esr.github.io/dev-doc/arch-soft-specif-security-rbac-test-case1/ </a>
 *
 * <h2>Version:</h2>
 *
 * 1.0.0
    ...
    mockMvc
        .perform(
            MockMvcRequestBuilders.get(authorizeEndPoint)
                ...
                .header(
                    "x-authorization",
                    accessTokenHelper.provideAccessToken(
                        unprivilegedUserLogin, unprivilegedUserPassword))
                .param("uri", accessControlShareReadEndPoint)
                .param("method", HttpMethod.POST.name())) // .andDo(print())
        .andExpect(status().isForbidden());
