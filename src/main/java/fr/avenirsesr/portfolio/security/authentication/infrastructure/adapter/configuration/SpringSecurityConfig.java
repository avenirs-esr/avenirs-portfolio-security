...
public class SpringSecurityConfig {
  ...
  // TODO Check why these properties are used. It is probably an error as it is used in
  // avenirs-portfolio-api microservice.
  @Value("${avenirs.storage.path}")
  private String storagePath;

  @Value("${avenirs.additionalskills.path}")
  private String additionalSkillsPath;
