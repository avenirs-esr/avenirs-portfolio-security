...
class JWTServiceTest {
  ...
  void testGetPublicKeyFailureKeyNotFound() {
    ...
    String jwksResponse =
        "{ \"keys\": [{ \"kid\": \"unknownKid\", \"n\": \"AKOx0nEfb2MP3iBwpQZ5Tx7gA5Mje6UAVAnzjEY64IBDdK5B9UPu7vE2YffIDVwo5KeJlWyNqkOBh5n8OEpuE6A=\", \"e\": \"AQAB\" }] }";
    mockWebServer.enqueue(new MockResponse().setBody(jwksResponse).setResponseCode(200));
  ...
  void testGetPublicKeyFailureInvalidAlgorithm() {
    ...
    String jwksResponse =
        "{ \"keys\": [{ \"kid\": \""
            + TEST_KID
            + "\", \"n\": \"AKOx0nEfb2MP3iBwpQZ5Tx7gA5Mje6UAVAnzjEY64IBDdK5B9UPu7vE2YffIDVwo5KeJlWyNqkOBh5n8OEpuE6A=\", \"e\": \"AQAB\" }] }";
    mockWebServer.enqueue(new MockResponse().setBody(jwksResponse).setResponseCode(200));
  ...
  void testGetPublicKeyFailureEmptyKID() {
    ...
    //noinspection SpellCheckingInspection
    String jwksResponse =
        "{ \"keys\": [{ \"kid\": \"\", \"n\": \"AKOx0nEfb2MP3iBwpQZ5Tx7gA5Mje6UAVAnzjEY64IBDdK5B9UPu7vE2YffIDVwo5KeJlWyNqkOBh5n8OEpuE6A=\", \"e\": \"AQAB\" }] }";
    mockWebServer.enqueue(new MockResponse().setBody(jwksResponse).setResponseCode(200));
