 ...
 * Interact with theOIDC provider and generates URL associated to OIDC end points.
 */
@Service
public class AuthenticationService {
	 ...
	 * @throws IOException
	 */
	public String generateAuthorizeURL(String host,
	...
	public String generateServiceURL(String host) throws IOException {
		...
		String serviceURL = serviceTemplate
				.replaceAll("%HOST%", host);
	 ...
	 * @throws IOException
	 */
	public String generateProfileURL(String token) throws IOException {
		
		String profileURL = oidcProviderProfileURL+"?token="+token;
		LOGGER.debug("generateServiceURL, profileURL: " + profileURL);
		return profileURL;
	}
	 ...
	 * @return The OIDCIntrospectResponse instance.
	 */
