...
class RBACActionRouteServiceTest {
  ...
  void testGetActionRouteByFilterByURIAndMethodPredicateF() {
    Optional<RBACActionRoute> response =
        actionRouteService.getAllActionRoutesBySpecification(
            RBACActionRouteSpecificationHelper.filterByURIAndMethod(route, method));
