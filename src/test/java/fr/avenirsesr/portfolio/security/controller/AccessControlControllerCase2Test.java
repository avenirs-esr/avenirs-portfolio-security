 ...
 *
 * <p>Description: test case 2. User gribonvald is pair for a resource of type MES. For more details
...
class AccessControlControllerCase2Test {
  ...
  @SpyBean private AccessControlService accessControlService;
    ...
    mockMvc
        .perform(
            MockMvcRequestBuilders.get(authorizeEndPoint)
                ...
                .header(
                    "x-authorization",
                    accessTokenHelper.provideAccessToken(userLogin, userPassword))
